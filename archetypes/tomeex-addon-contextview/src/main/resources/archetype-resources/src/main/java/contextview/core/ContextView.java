...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.contextview.core;
...
/**
 * Represents a single ContextView in the JSON-Driven Architecture.
 *
 * A ContextView defines:
...
public class ContextView {
    ...
    private ContextViewOptions options;
    private List<BreadcrumbEntry> breadcrumbs;

    // Constructors
    public ContextView() {}

    public ContextView(String key, String title, String component) {
        this.key = key;
        this.title = title;
    ...
    public ContextViewOptions getOptions() {
        return options;
    }

    public void setOptions(ContextViewOptions options) {
    ...
    /**
     * Menu configuration for contextview
     */
